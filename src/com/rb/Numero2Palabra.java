...
/**
 * http://www.lawebdelprogramador.com/codigo/Java/338-Convertir-numeros-a-letras.html
 *
 * @author ballestax
 */
public class Numero2Palabra {
    ...
    public Numero2Palabra() {
        numero = 0;
        flag = 0;
    }

    public Numero2Palabra(int n) {
        numero = n;
        flag = 0;
    }
