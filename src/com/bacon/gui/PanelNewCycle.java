...
public class PanelNewCycle extends PanelCapturaMod implements ActionListener {
    ...
    private void initComponents() {
        ...
        regIDciclo = new com.bacon.gui.util.Registro(BoxLayout.X_AXIS, "ID ciclo", "",100);
        regSaldo = new com.bacon.gui.util.Registro(BoxLayout.X_AXIS, "Saldo inicial", "",100);
    ...
    private com.bacon.gui.util.Registro regIDciclo;
    private com.bacon.gui.util.Registro regSaldo;
